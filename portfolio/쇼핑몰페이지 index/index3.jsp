		...
		<section class="slider">
			<div class="slides">
				...
				<div class="slide first">
					<img src="./banners/banner0.png" class="slide_item">
				</div>
				<div class="slide">
					<img src="./banners/banner1.png" class="slide_item">
				</div>
				<div class="slide">
					<img src="./banners/banner2.png" class="slide_item">
				</div>
			...
			<div class="navigation-manual">
				<label for="radio1" class="manual-btn" id="manual-btn"></label>
...
<script>
	var counter = 1;
	document.getElementById("manual-btn").style.backgroundColor = "red";
	setInterval(function(){
		if(counter == 1){
			document.getElementById("manual-btn").style.backgroundColor = "";
		}
